...
export default function LiveKitVoiceChat() {
  ...
  const checkBackend = () => {
    ...
    // Add backend check logic here
  };

  const handleStartChat = () => {
    console.log('🚀 Starting conversation with Adina...');
    startVoiceChat('Adina');
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.characterProfile}>
          ...
          <Text style={styles.characterName}>Adina</Text>
        </View>
        <Text style={styles.characterDescription}>Compassionate AI Companion</Text>
      ...
      {!isActive && (
        <View style={styles.readySection}>
          ...
          <Text style={styles.readyText}>Ready to talk with Adina</Text>
        </View>
      )}
      ...
      {isActive && (
        <View style={styles.activeSection}>
          ...
          <Text style={styles.activeText}>Chatting with Adina</Text>
          <TouchableOpacity
      ...
      <View style={styles.buttonContainer}>
        {!isActive && (
          ...
          >
            ...
            <Text style={styles.buttonText}>Talk with Adina</Text>
          </TouchableOpacity>
        )}
